...
/**
 * exports the Details for the Projects in English
 */
...
/**
 * exports the Details for the Projects in German
 */
export const PROJECTS_DE: Project[] = [
  ...
  },
  {
    ...
    technologies: ['HTML', 'CSS', 'JavaScript'],
    description:
      "Jump'n'Run-Spiel basierend auf einem objektorientierten Ansatz. Helfen Sie Pepe, Münzen und Tabasco-Soße zu finden, um gegen das verrückte Huhn zu kämpfen.",
    liveLink: 'https://bjoern-bressler.de/developer/projects/el-pollo-loco/',
    gitHubLink: 'https://github.com/MatheGenie27/el-pollo-loco2',
    imagePath: 'assets/img/elPolloLocoRedux.png',
  },
