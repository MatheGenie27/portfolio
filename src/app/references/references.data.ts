...
export const TEST_REFERENCES_EN: Testimonial[] = [
    {
        ...
        testimonialText: '"Björn is a true professional. His attention to detail and ability to write clean, efficient code made our website project a huge success!"'
    },
    {
        id: 2,
        name: "Tom Bauer",
        project: "App Development",
        testimonialText: '"Working with Björn was an incredible experience. He not only delivered high-quality code but also explained complex concepts in a way everyone could understand."'
    },
    {
        id: 3,
        name: "Sophia Meier",
        project: "API Integration",
        testimonialText: '"Björn’s expertise in integrating APIs saved us so much time. His debugging skills are unmatched, and he always finds the most elegant solutions."'
    },
    {
        id: 4,
        name: "Lukas Wagner",
